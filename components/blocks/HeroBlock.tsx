    ...
    <section className="py-4">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-2xl">
          ...
          <div
            className="absolute inset-0 z-10 bg-gradient-to-br from-white/75 to-white/0 lg:bg-gradient-to-tl lg:from-white lg:to-white/0"
          />

          {/* Декоративная линия SVG */}
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 z-10 w-[110%] h-auto pointer-events-none lg:left-auto lg:right-0 lg:translate-x-0 lg:w-[65%] lg:-bottom-16">
            <svg 
