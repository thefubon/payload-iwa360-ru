...
- **Функционал:**
  ...
  - ✅ Красивый шаблон страницы с градиентом
- REST: `/api/pages`
...
### v1.1.0 - Система управления страницами и улучшенная навигация
- ✅ Добавлена коллекция Pages (Страницы)
- ✅ Динамический роутинг `[slug]` для страниц
- ✅ Активное состояние навигации
- ✅ Автоматическая нормализация URL
- ✅ Header с поддержкой выпадающих меню
- ✅ Компоненты UI (shadcn/ui + Radix UI)
- ✅ Типизация для страниц и компонентов
- ✅ Группировка коллекций в админке

### v1.0.0 - Начальный релиз
- Настройки сайта (Settings)
- Облачное хранилище (Vercel Blob)
