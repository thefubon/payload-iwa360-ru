...
export const Forms: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      required: false,
      admin: {
        description: '✨ Быстрый старт! Выберите готовый шаблон формы. После выбора сохраните форму - поля добавятся автоматически.',
        position: 'sidebar',
      },
      options: [
        ...
        { label: '🎪 Демонстрация продукта', value: 'demo' },
        { label: '⭐ Оставить отзыв', value: 'feedback' },
      ],
    },
    {
      type: 'tabs',
